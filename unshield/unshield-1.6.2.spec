...
Source0:        https://github.com/twogood/unshield/archive/refs/tags/%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
%dir %{_libdir}/cmake/unshield
%{_libdir}/cmake/unshield/*

%changelog
* Thu May 22 2025 Martin rs - 1.6.2
- Update
* Sat Aug 31 2024 Martin RS - 1.5.2
- Update for latest Fedora
